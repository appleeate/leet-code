	...
	class Automaton {
		...
		*/
		get(char) {
			...
			*/
			this.state = this.map.get(this.state)[Automaton.getIndex(char)];
...
console.log(myAtoi1("1213哈哈哈"));

// 作者：gatsby-23
// 链接：https://leetcode-cn.com/problems/string-to-integer-atoi/solution/javascriptzi-dong-ji-guan-fang-ti-jie-de-xiang-xi-/
// 	来源：力扣（LeetCode）
